...
print "python plot_simulation_section.py --true %s --fitted %s --model-types %s --x-lab '%s' --x-labels %s" % (true_model_arg, fitted_str, model_types_str, xlab, ":".join([str(x) for x in xlabels]))
