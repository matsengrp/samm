...
class FeatureGeneratorTestCase(unittest.TestCase):
    def test_update(self):
        ...
        base_feat_vec_dicts, base_intermediate_seqs, _ = feat_generator.create_for_mutation_steps(
            ordered_seq_mut,
        )
        ...
        feat_vec_dicts1_update, intermediate_seqs1_update, _ = feat_generator.update_for_mutation_steps(
            ordered_seq_mut1,
            update_steps=[1],
        ...
        feat_vec_dicts1, intermediate_seqs1, _ = feat_generator.create_for_mutation_steps(
            ordered_seq_mut1
        )
        ...
        feat_vec_dicts2_update, intermediate_seqs2_update, _ = feat_generator.update_for_mutation_steps(
            ordered_seq_mut2,
            update_steps=[0,1],
        ...
        feat_vec_dicts2, intermediate_seqs2, _ = feat_generator.create_for_mutation_steps(
            ordered_seq_mut2
        )
