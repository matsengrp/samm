...
class FeatureGeneratorTestCase(unittest.TestCase):
    def test_create(self):
        ...
        # Create the base_feat_vec_dicts and base_intermediate_seqs
        base_feat_mut_steps = feat_generator.create_for_mutation_steps(ordered_seq_mut, left_update, right_update)
        self.assertEqual(base_feat_mut_steps[0].mutating_pos_feats, 0)
        self.assertEqual(base_feat_mut_steps[1].mutating_pos_feats, 1)
        self.assertEqual(base_feat_mut_steps[2].mutating_pos_feats, 1)
        self.assertEqual(base_feat_mut_steps[3].mutating_pos_feats, 0)
